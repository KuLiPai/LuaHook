...
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.AND;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.ASSIGN;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.AT;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.BAD_CHARACTER;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.BIT_AND;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.BIT_LTLT;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.BIT_OR;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.BIT_RTRT;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.BIT_TILDE;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.BLOCK_COMMENT;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.BREAK;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.CASE;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.COLON;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.COMMA;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.CONCAT;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.CONTINUE;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.DEFAULT;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.DIV;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.DO;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.DOC_COMMENT;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.DOT;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.DOUBLE_COLON;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.DOUBLE_DIV;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.ELLIPSIS;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.ELSE;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.ELSEIF;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.END;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.ENDREGION;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.EQ;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.EXP;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.FALSE;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.FOR;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.FUNCTION;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.GE;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.GETN;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.GOTO;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.GT;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.IF;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.IN;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.LBRACK;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.LCURLY;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.LE;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.LEF;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.LOCAL;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.LONG_STRING;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.LPAREN;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.LT;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.MEAN;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.MINUS;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.MOD;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.MULT;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.NAME;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.NE;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.NEW_LINE;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.NIL;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.NOT;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.NUMBER;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.OR;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.PLUS;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.RBRACK;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.RCURLY;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.REGION;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.REPEAT;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.RETURN;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.RPAREN;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.SEMI;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.SHEBANG;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.SHEBANG_CONTENT;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.SHORT_COMMENT;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.STRING;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.SWITCH;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.THEN;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.TRUE;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.UNTIL;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.WHEN;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.WHILE;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.WHITE_SPACE;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.LAMBDA;
import static io.dingyi222666.sora.lua.tool.LuaTokenTypes.DEFER;
